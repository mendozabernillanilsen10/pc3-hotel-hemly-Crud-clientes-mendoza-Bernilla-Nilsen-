			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">LISTA DE  CLIENTES</h4>
                                <a href="add-booking.html" class="btn btn-primary float-right veiwbutton ">Agregar Nueva Nuevo cliente</a>
                            </div>
						</div>
					</div>
				</div>
									...
									<table class="datatable table table-stripped table table-hover table-center mb-0">
											...
											<tr>
												...
												<th>ESTADO</th>
                                                                               ...
                                                                               <c:forEach var="em" items="${lista_Empleados}">
                                                                                    <tr>
                                                                                        <td>${em.getId_cliente()}</td>
                                                                                        <td>${em.getId_documento()}</td>
                                                                                        <td>${em.getNombre()}</td>
                                                                                        <td>${em.getApellido()}</td>
                                                                                        <td>${em.getId_genero()}</td>
                                                                                        <td>${em.getId_direccion()}</td>  
                                                                                                                                                                              <td>
