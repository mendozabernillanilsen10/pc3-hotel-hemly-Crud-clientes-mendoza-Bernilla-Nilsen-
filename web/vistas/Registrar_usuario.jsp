					...
					<div class="login-right">
						<div class="login-right-wrap">
							...
							<div class="login-or"> <span class="or-line"></span> <span class="span-or">or</span> </div>
                                                                    <div class="social-login"> <span>Registrar con facebook</span> <a href="#" class="facebook"><i class="fab fa-facebook-f">
                                                            
                                                                </i></a><a href="#" class="google"><i class="fab fa-google"></i></a> </div>
							<div class="text-center dont-have">YA TENGO CUENTA ? <a href="../index.jsp">Login</a> </div>
						</div>
					</div>
				</div>
			</div>
